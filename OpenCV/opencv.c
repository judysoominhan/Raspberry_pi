...
int main() {
	IplImage *image1 = cvLoadImage("1.bmp", CV_LOAD_IMAGE_COLOR);
	IplImage *image2 = cvLoadImage("ladybugs.bmp", CV_LOAD_IMAGE_COLOR);
	...
	cvNamedWindow("IMAGE_MULTIPLICATION",
																																						CV_WINDOW_AUTOSIZE); cvNamedWindow("IMAGE_DIVISION", CV_WINDOW_AUTOSIZE); cvNamedWindow("IMAGE_GRAY1", CV_WINDOW_AUTOSIZE); cvNamedWindow("IMAGE_GRAY2", CV_WINDOW_AUTOSIZE); cvNamedWindow("IMAGE_WHITE", CV_WINDOW_AUTOSIZE);
	...
	cvThreshold(image_gray_sub, image_white, 100, 255,
																																																																														   CV_THRESH_BINARY);
